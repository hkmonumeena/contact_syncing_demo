package com.developermonu.contactsyncing.viewmodels
...
class ContactsViewModel(val mApplication: Application):AndroidViewModel(mApplication) {
    private val _getAllContacts =
        MutableStateFlow(arrayListOf<Contact>())
    val getAllContacts = _getAllContacts.asStateFlow()
    ...
    fun fetchContacts() {
        viewModelScope.launch {
            ...
            _getAllContacts.value = contacts
        }
    }
